...
Block explorers form the core infrastructure for blockchain data transparency and accessibility, acting as interfaces between decentralized networks and end users. This whitepaper presents a systematic and quantitative evaluation of the current state of the technology, based on a comparative study of 12 major explorers from 6 blockchain ecosystems (Bitcoin, Ethereum, Polkadot, Cosmos, Solana, and Multi-chain). We identified three dominant architectural patterns (Monolithic: 25%, Microservices: 42%, Hybrid: 33%) and developed a multidimensional classification framework based on five technical dimensions: architecture, data processing, interface, API, and performance optimization. Our analysis indicates that hybrid explorers offer the best balance between scalability and maintainability, while microservices demonstrate superior performance in high-concurrency scenarios. We identified 5 critical research gaps and suggest future directions for technology evolution. This work addresses a gap in academic literature by providing what appears to be the first systematic taxonomy of block explorers and establishing foundations for developing optimized systems.
